...
const SecondView = () => {
  return (
    <section className='max-w-[1440px] m-auto overflow-hidden relative'>
      <div className='flex justify-between px-[120px] gap-20 relative'>
        <div className='flex-1'>
          <h2 className='font-bold text-darkblue leading-[3.3rem] text-[2.3rem] mb-4'>What’s different about Manage?</h2>
