  ...
  return (
    <section className='widthMax overflow-hidden relative'>
      <div className='flex flex-col md:flex-row justify-between md:contentpadding md:gap-20 gap-14 relative'>
        ...
        <Image priority={false} src="/images/bg-tablet-pattern.svg" alt='tablet-pattern' className='absolute bottom-[-570px] left-[-500px] z-[-1] max-md:hidden' width="814" height="814" />
      </div>
      <Testimonial/>
    </section>
  )
